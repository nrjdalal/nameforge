...
const ACCENT_COLORS: AccentColor[] = [
  { top: "bg-[#111]", bottom: "bg-black", text: "text-white" },
  { top: "bg-[#ecebe5]", bottom: "bg-white", text: "text-black" },
  { top: "bg-neutral-300", bottom: "bg-neutral-400", text: "text-black" },
]
  ...
  function FlapCell({
    ...
    return (
      <div className="flex aspect-[1/2] flex-col overflow-hidden rounded-[2px] border border-neutral-300 md:rounded-[3px] md:border-2 dark:border-black">
        ...
        <div className="h-1 w-full bg-neutral-300 dark:bg-black/50 opacity-20 md:h-2" />
      </div>
    )
  },
  (prevProps, nextProps) =>
