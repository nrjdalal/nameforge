    ...
    <div className="relative min-h-screen text-[#1a1a1a] flex items-center justify-center p-4 selection:bg-[#1a1a1a] selection:text-[#ecebe5]">
      ...
      <main className="w-full max-w-6xl aspect-[4/3] bg-white border border-[#1a1a1a] shadow-2xl overflow-hidden flex flex-col relative layout-container z-10">
        ...
        <div className="flex-1 grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="p-6 lg:p-12 border-r border-[#1a1a1a] flex flex-col relative overflow-hidden">
          ...
          <div className="flex flex-col">
            ...
            <div className="grid grid-cols-2 flex-grow min-h-[140px]">
              <Link
                href="/commands"
                className="group p-6 lg:p-8 flex flex-col items-start justify-center border-r border-[#1a1a1a] bg-[#ecebe5] hover:bg-[#1a1a1a] hover:text-white transition-colors"
              >
                <span className="font-mono text-[10px] uppercase tracking-widest opacity-60 mb-2 group-hover:opacity-100">
                  Reference
                </span>
              ...
              <Link
                href="/try"
                className="group p-6 lg:p-8 flex flex-col items-start justify-center bg-[#1a1a1a] text-[#ecebe5] hover:bg-[#ecebe5] hover:text-[#1a1a1a] transition-colors"
              >
                <span className="font-mono text-[10px] uppercase tracking-widest opacity-60 mb-2 group-hover:opacity-100 group-hover:text-[#1a1a1a]">
                  Action
                </span>
                <h2 className="font-serif text-2xl lg:text-3xl font-bold uppercase tracking-tight">
                  Studio
